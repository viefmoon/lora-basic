...
// ==========================================================
//              DEFINICIONES COMUNES PARA TODOS LOS DISPOSITIVOS
// ==========================================================
...
// Pines para pt100 sensor de temperatura
#define PT100_CS_PIN    P03        

// Pines de PowerManager
#define POWER_3V3_PIN   P00        // Fuente de 3.3V para sensores (Todos los dispositivos)
#define POWER_12V_PIN   P01        // Fuente de 12V (Solo tipo Modbus y Analógico)
#define POWER_2V5_PIN   P02        // Fuente de 2.5V y -2.5 (Solo analógico)
...
#define BATTERY_PIN 1 // Pin del esp32 para la lectura del voltaje de la batería (Solo tipo Basic y Modbus)
#define BATTERY_ADC_CHANNEL 1 // Canal ADC para la lectura del voltaje de la batería (Solo tipo Analógico)
...
#define SPI_ADC_CLOCK     100000    // 100 kHz - Velocidad para el ADC m08
#define SPI_RTD_CLOCK     1000000   // 1 MHz - Velocidad para el sensor MAX31865 (RTD - PT100)
#define SPI_RADIO_CLOCK   100000    // 100 kHz - Velocidad para la radio LoRa
...
// Claves comunes para configuración (NVS/Preferences)
...
// ==========================================================
//              DEFINICIONES ESPECÍFICAS POR TIPO DE DISPOSITIVO
// ==========================================================
...
// -------------------- DISPOSITIVO ANALÓGICO --------------------
    ...
    // BLE características específicas
    ...
    // Claves para configuración NTC 100K
    ...
    // Claves para configuración NTC 10K
    ...
    // Claves para configuración de Conductividad
    ...
    // Claves para configuración de pH
